  ...
  return (
    <div className="fixed inset-0 bg-[white]/90 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white border border-[#1A1A1A] w-full max-w-md animate-in fade-in zoom-in-95 duration-200 shadow-[8px_8px_0_0_rgba(26,26,26,1)] flex flex-col max-h-[90vh]">
        <div className="flex items-center justify-between px-8 py-6 border-b border-[#1A1A1A] bg-[white] shrink-0">
          <div>
          ...
          <button onClick={onClose} className="p-2 text-[#1A1A1A] hover:bg-[#1A1A1A] hover:text-[white] transition-colors border border-transparent hover:border-[#1A1A1A]">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4 overflow-y-auto">
          ...
          <div className="pt-4 flex justify-end">
            <button 
              type="submit"
              className="px-8 py-3 border border-[#1A1A1A] bg-[#1A1A1A] text-[white] text-[10px] uppercase tracking-widest font-bold hover:bg-transparent hover:text-[#1A1A1A] transition-all"
            >
