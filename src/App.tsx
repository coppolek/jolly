  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white text-[#1A1A1A]">
      <div className="max-w-md w-full p-12 bg-white border border-[#1A1A1A] shadow-[8px_8px_0_0_rgba(26,26,26,1)] text-center">
        ...
        <button 
          onClick={login}
          className="w-full px-8 py-4 border border-[#1A1A1A] bg-[#1A1A1A] text-[white] text-[10px] uppercase tracking-widest font-bold hover:bg-transparent hover:text-[#1A1A1A] transition-all"
        >
          Sign in with Google
        </button>
      </div>
